...
const RsmPerformanceTable = ({
  // Renamed component
  selectedRowId,
  onRowSelect,
  performanceTableQTY = [],
  performanceTableVAL = [],
  title = "RSM Performance", // Default title updated
}) => {
  // console.log("RSM performanceTableQTY", performanceTableQTY);
  // console.log("RSM performanceTableVAL", performanceTableVAL);
  // Placeholder data similar to the image
  const defaultData = [
    {
      id: 1,
      name: "RSM 1", // Updated placeholder name
      isp: "1234.24K",
      yesterday: "1234.24K",
      mtd: "1234.24K",
      avg: "1234.24K",
    ...
    // ... other placeholder rows if needed ...
  ];
  ...
  return (
    ...
    >
      ...
      <TableContainer component={Box}>
        ...
        <Table sx={{ minWidth: 650 }} aria-label="rsm performance table">
          {" "}
          {/* aria-label updated */}
          <TableHead>
            <TableRow>
          ...
          <TableBody>
            ...
            {extractedTotalRow && (
              ...
              >
                ...
                <TableCell sx={totalRowStyle}>
                  {formatNumberKMB(
                    extractedTotalRow.isp || extractedTotalRow.noOfISP
                  )}{" "}
                  {/* Adjusted key */}
                </TableCell>
                <TableCell sx={totalRowStyle}>
            ...
            {currentData.map((row) => (
              ...
              >
                ...
                >
                  {formatNumberKMB(row.isp || row.noOfISP)}
                </TableCell>{" "}
                {/* Adjusted key */}
                <TableCell
                  sx={{
...
export default RsmPerformanceTable; // Updated export
