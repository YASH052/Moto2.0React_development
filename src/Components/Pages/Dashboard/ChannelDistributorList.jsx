...
const ChannelDistributorList = ({channelDistributorValueList,channelDistributorQuantityList}) => {
  const [showValueData, setShowValueData] = useState(false);
  
  const displayData = showValueData ? channelDistributorValueList : channelDistributorQuantityList;
          ...
          <TableBody>
            {displayData && displayData.map((row, index) => (
              <TableRow key={index} sx={{ backgroundColor: LIGHT_GRAY2 }}>
                ...
                <TableCell sx={CellStyles}>{row.woi}</TableCell>
                ...
                <TableCell sx={CellStyles}>{row.soh}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
...
export default ChannelDistributorList;
