...
const ChannelProductList = ({channelProductValueList,channelProductQuantityList}) => {
  const [showValueData, setShowValueData] = useState(false);
  
  const displayData = showValueData ? channelProductValueList : channelProductQuantityList;
