...
const ViewUser = () => {
  ...
  const rows = [
    {
      ...
      locationCode: "Column 1",
      username: "Column 1",
      parentLocation: "Column 1",
      parentUserName: "Column 1",
      status: true,
    },
    {
      id: 2,
  ...
  const tableColumns = [
    { id: "hierarchy", label: "HIERARCHY", sortable: true },
    { id: "locationName", label: "LOCATION NAME", sortable: true },
    { id: "locationCode", label: "LOCATION CODE", sortable: true },
    { id: "username", label: "USERNAME", sortable: true },
    { id: "parentLocation", label: "PARENT LOCATION", sortable: true },
    { id: "parentUserName", label: "PARENT USER NAME", sortable: true },
              ...
              >
                ...
                >
                  ...
                  <Grid item xs={12} sm={6} md={3} lg={3}>
                    ...
                    <NuralTextField width="100%" placeholder="LOCATION CODE" />
                  </Grid>
            ...
            <Table sx={{ minWidth: 650 }} size="small" stickyHeader>
              ...
              <TableBody>
                {filteredRows
                  ...
                  .map((row, index) => (
                    <TableRow key={row.id}>
                      <TableCell sx={{ ...rowstyle }}>{row.hierarchy}</TableCell>
                      <TableCell sx={{ ...rowstyle }}>{row.locationName}</TableCell>
                      <TableCell sx={{ ...rowstyle }}>{row.locationCode}</TableCell>
                      <TableCell sx={{ ...rowstyle }}>{row.username}</TableCell>
                      <TableCell sx={{ ...rowstyle }}>{row.parentLocation}</TableCell>
                      <TableCell sx={{ ...rowstyle }}>{row.parentUserName}</TableCell>
