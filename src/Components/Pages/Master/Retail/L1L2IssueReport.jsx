...
const L1L2IssueReport = () => {
  ...
  const generateDummyData = () => {
    ...
    const codes = ["EMP001", "EMP002", "EMP003", "EMP004", "EMP005"];
    const issueTypes = [
      "Hardware",
      "Software",
      "Network",
                ...
                {filteredRows
                  ...
                  .map((row, index) => (
                    <TableRow key={row.id}>
                      ...
                      <TableCell sx={{ ...rowstyle }}>{row.issue}</TableCell>
                      <TableCell sx={{ ...rowstyle }}>{row.raisedOn}</TableCell>
