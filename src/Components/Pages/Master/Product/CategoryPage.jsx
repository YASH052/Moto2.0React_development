...
const CategoryPage = () => {
  ...
  const generateDummyData = () => {
    const brands = ["Samsung", "LG", "Sony", "Apple", "Xiaomi", "OnePlus", "Lenovo", "HP", "Dell"];
    const categories = [
    ...
    return Array(50)
      ...
      .map((_, index) => ({
        ...
        categoryCode: `${categories[Math.floor(Math.random() * categories.length)].code}-${String(Math.floor(1000 + Math.random() * 9000))}`,
