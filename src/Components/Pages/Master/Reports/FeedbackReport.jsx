...
const FeedbackReport = () => {
  const [activeTab, setActiveTab] = React.useState("feedback-report");
  ...
  const generateDummyData = () => {
    ...
    const category = ["Smartphone", "Tablet", "Laptop", "Accessories", "Wearables"];
    const model = ["Galaxy S21", "iPhone 13", "Xperia 1", "G8", "Edge 30", "N9"];
    const remarks = ["Good", "Bad", "Average", "Excellent", "Poor", "Very Good"];
    const image1 = ["Image1.jpg", "Image2.jpg", "Image3.jpg", "Image4.jpg", "Image5.jpg", "Image6.jpg"];
    const image2 = ["Image1.jpg", "Image2.jpg", "Image3.jpg", "Image4.jpg", "Image5.jpg", "Image6.jpg"];
    const image3 = ["Image1.jpg", "Image2.jpg", "Image3.jpg", "Image4.jpg", "Image5.jpg", "Image6.jpg"];
    ...
    return Array(50)
      ...
      .map((_, index) => ({
        ...
        image1: image1[Math.floor(Math.random() * image1.length)],
        image2: image2[Math.floor(Math.random() * image2.length)],
        image3: image3[Math.floor(Math.random() * image3.length)],
      }));
  };
        ...
        <Grid item xs={12} sx={{ p: { xs: 1, sm: 2 } }}>
          <TableContainer
            ...
            sx={{
              backgroundColor: LIGHT_GRAY2,
              color: PRIMARY_BLUE2,
              maxHeight: "calc(100vh - 165px)", // Add max height for scrolling
              overflow: "auto",
            }}
          >
              ...
              <TableHead>
                ...
                <TableRow sx={{ backgroundColor: LIGHT_GRAY2 }}>
                  ...
                  {[
                       { id: "Name", label: "NAME" },
                       { id: "Type", label: "TYPE" },
                       { id: "Channel Name", label: "CHANNEL NAME" },
                       { id: "Channel Code", label: "CHANNEL CODE" },
                ...
                {filteredRows
                  ...
                  .map((row, index) => (
                    <TableRow key={row.id}>
                      ...
                      <TableCell sx={{ ...rowstyle }}><span style={{display: 'flex', alignItems: 'center', gap: '5px'}}>{"view"}<VisibilityIcon fontSize={'12px'}/></span></TableCell>
                      <TableCell sx={{ ...rowstyle }}> <span style={{display: 'flex', alignItems: 'center', gap: '5px'}}>{"view"}<VisibilityIcon fontSize={'12px'}/></span></TableCell>
                      <TableCell sx={{ ...rowstyle }}><span style={{display: 'flex', alignItems: 'center', gap: '5px'}}>{"view"}<VisibilityIcon fontSize={'12px'}/></span></TableCell>
                    </TableRow>
                  ))}
