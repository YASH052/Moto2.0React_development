...
const Search = () => {
  ...
  const rows = [
    {
      id: 1,
      retailerName: "Sample Retailer 1",
      retailerCode: "RT001",
      scrCategory: "Category A",
      model: "Model X",
    },
    {
      id: 2,
      retailerName: "Sample Retailer 2",
      retailerCode: "RT002",
      scrCategory: "Category B",
      model: "Model Y",
    },
  ];
  ...
  const tableColumns = [
    { id: "retailerName", label: "RETAILER NAME", sortable: true },
    { id: "retailerCode", label: "RETAILER CODE", sortable: true },
    { id: "scrCategory", label: "SCR CATEGORY", sortable: true },
                ...
                {filteredRows
                  ...
                  .map((row, index) => (
                    <TableRow key={row.id}>
                      ...
                      <TableCell sx={{ ...rowstyle }}>{row.scrCategory}</TableCell>
