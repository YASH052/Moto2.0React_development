...
import { tableHeaderStyle, rowstyle, labelStyle, headTitle} from "../../../../../Common/commonstyles";
      ...
      >
        ...
        >
          <Grid item xs={12} sm={6} md={6} lg={6}>
            <Typography sx={labelStyle}>LEAVE TYPE CODE</Typography>
            <NuralAutocomplete
              width="100%"
        ...
        <Grid item xs={12} md={12} lg={12}>
          <Grid item>
            <Box backgroundColor={LIGHT_GRAY2} padding={2} borderRadius={2}>
              <Typography sx={headTitle}>Rejection Remark</Typography>
