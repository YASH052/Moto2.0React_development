...
// console.log(log)
const SecondarySaleReturn = () => {
  const [activeTab, setActiveTab] = React.useState("secondary-sale-return");
  ...
  const handleUploadClick = async () => {
    ...
    try {
      let res = await UploadSecondarySalesReturn(
        formData,
        formattedDate,
        selectedUserId
      );
...
export default SecondarySaleReturn;
